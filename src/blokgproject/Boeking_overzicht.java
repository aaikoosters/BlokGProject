 ...
 * @author Aaik
 */
public class Boeking_overzicht extends javax.swing.JFrame {
...
//        locatieTable.getColumn("Telefoonnummer").setCellRenderer(rightRenderer);
    ...
    private void initComponents() {
        ...
        jButton3.setText("Boeking maken");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Boeking_overzicht.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Boeking_overzicht().setVisible(true);
            }
        });
    }
